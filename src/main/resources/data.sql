INSERT INTO customer (birth_date, created_at, email, experience_points, gender, location, name, nickname, password, phone) values ("2000-01-01", "2024-10-21 10:00:00", "one@example.com", 0, "M", "광진구", "김하나", "하나", "root1234", "010-1234-5678");
...
INSERT INTO post (customer_id, title, category_id, location, content, created_at, updated_at, like_count, scrap_count, view_count) values (1, "다들 예금 얼마나 하고 계시나요?", 1, "성동구", "궁금합니다!", "2024-12-18 15:30:00", null, 6, 0, 8 );
INSERT INTO post (customer_id, title, category_id, location, content, created_at, updated_at, like_count, scrap_count, view_count) values (2, "다들 예금 얼마나 하고 계시나요?", 2, "광진구", "궁금합니다!", "2024-12-19 15:30:00", null, 7, 0, 7 );
INSERT INTO post (customer_id, title, category_id, location, content, created_at, updated_at, like_count, scrap_count, view_count) values (3, "다들 예금 얼마나 하고 계시나요?", 3, "서초구", "궁금합니다!", "2024-12-20 15:30:00", null, 8, 0, 6 );
