...
INSERT INTO question (customer_id, category_id, title, content, location, created_at, updated_at, like_count, scrap_count, view_count) values (2, 3, "달달하나", "일반 급여통장과의 차이점이 무엇인가요? 어떤 혜택이 있는지 알고싶어요!", "성동구", "2024-12-27 13:52:00", null, 295, 25, 2879);
